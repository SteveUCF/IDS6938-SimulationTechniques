...
//{
	...
	*/
	...
	//Alex and Charlie assisted me on this code
	void SIMAgent::Control()
	{
...
//Roberto and Charlie assisted me on this code
vec2 SIMAgent::Avoid()
{
	/*********************************************
	// TODO: Add code here
...
vec2 SIMAgent::Separation()
{
	...
	*********************************************/
	vec2 tmp;
	//∑n∈N  ((goal- position)/ |(goal - position)|)*SeperateConstant
	return tmp;
}
	...
	*********************************************/
	...
	for (int i = 0; i < agents.size(); i++ )
	{
		...
		if (((agentX != 0.0) || (agentY != -.0)) && (agentPosVec.Length() < RNeighborhood))
		{
			...
			normalAgentV += agentsV.Normalize();
	...
	VelAlignment = (KAlign * normalAgentV);
...
vec2 SIMAgent::Cohesion()
{
	...
	*********************************************/
	...
	//∑n∈N ^npos.|(SIMAgent::agents.size())|

	//Roberto and Charlie helped in the construction of the coding of this function//
	vec2 tmp;
	...
	for (int i = 0; i < agents.size(); i++)
	{
		...
		VCohesion = KCohesion * ((agentsV / agents.size()) - GPos);
	...
	vec2 SIMAgent::Flocking()
{
	...
	*********************************************/
	...
	//		Vflock = cseperateVseperate + calignValign + ccohesionVcohesion
	// Roberto and Charlie assisted me on this function
	vec2 tmp;
	vec2 vFlock;
...
vec2 SIMAgent::Leader()
{
	...
	*********************************************/
	...
	//	Vleaderfollow = cseperateVseperate + carrivialVarrivial
	vec2 tmp;
	vec2 vLeader;
